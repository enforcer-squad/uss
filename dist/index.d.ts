...
export declare const getData: (keys: (string | number)[], defaultValue?: any) => any;
...
export declare const getReactiveData: <T extends Config>(keys: (string | number)[], defaultValue?: T | undefined) => Proxied<T>;
export declare const invalidateData: (keys: (string | number)[]) => void;
...
export type Cachekey = (string | number)[] | ((...args: any[]) => (string | number)[]);
export type Config = {
	key?: string;
	[key: string]: any;
};
